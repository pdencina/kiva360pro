    ...
    <div className="min-h-screen bg-[#f8f9fb] flex items-center justify-center p-8">
      <div className="w-full max-w-sm">
        <div className="flex items-center gap-3 mb-10 justify-center">
          <Image src={BRANDING.logoPath} alt={BRANDING.logoAlt} width={38} height={38} className="rounded-lg"/>
          <span className="font-semibold text-[#1a2332] text-lg tracking-tight" style={{ fontFamily: 'DM Sans, sans-serif' }}>{BRANDING.appName}</span>
        </div>
